...
public class ChessGameCmdLine implements Observer{
	...
	public void go() {
		...
		System.out.print("\n Mouvement du fou blanc = ");
		chessGameControler.move(new Coord(2,7), new Coord(7, 2));
		
		System.out.print("\n Mouvement de la renne noire = ");
		chessGameControler.move(new Coord(3,0), new Coord(3, 3));
		
		System.out.print("\n Mouvement du cavalier blanc = ");
		chessGameControler.move(new Coord(6,7), new Coord(5, 6));
		...
		System.out.print("\n Déplacement de 3,4 vers 4,3 = ");
		chessGameControler.move(new Coord(3, 4), new Coord(4, 3));*/
